        ...
        children: [
          StreamBuilder(
              stream: Firestore.instance
                  .collection('users')
                  .document(widget.profileId==null?currentUser.id:widget.profileId)
                  .snapshots(),
              builder: (context, snapshot) {
                print('asd   ${widget.profileId}  curruser  ${currentUser.id}');
                      ...
                      child: Container(
                        ...
                        child: ListView(
                          ...
                          children: snapshot.data.documents
                              .map(
                                (e) => Padding(
                                  padding: snapshot.data.documents.length== 1? const EdgeInsets.all(6.0): const EdgeInsets.all(8.0),
                                  child: Material(
