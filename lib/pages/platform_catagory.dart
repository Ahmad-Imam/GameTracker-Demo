...
class PlatformCatagory extends StatefulWidget {
  PlatformCatagory({this.pname, this.link});

  final String pname;
  final String link;

  @override
  _PlatformCatagoryState createState() => _PlatformCatagoryState();
}

class _PlatformCatagoryState extends State<PlatformCatagory>
    with TickerProviderStateMixin {
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    //print('link ${widget.link} and name ${widget.pname}');
    //print('ID: ${widget.id}');
  }
...
//        ),
            StreamBuilder<QuerySnapshot>(
                stream: Firestore.instance.collection('games')
